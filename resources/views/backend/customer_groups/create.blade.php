    ...
    <div class="page-inner">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-gradient-primary text-white d-flex justify-content-between align-items-center">
                <h4 class="mb-0">
                    <i class="fas fa-users me-2"></i> Thêm nhóm khách hàng mới
                </h4>
            ...
            <div class="card-body p-4">
                ...
                <form action="{{ route('admin.customer-groups.store') }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" id="description" rows="4"
                                ...
                                placeholder="Nhập mô tả về nhóm khách hàng (không bắt buộc)">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <button type="submit" class="btn btn-primary px-4">
                            <i class="fas fa-save me-2"></i> Lưu nhóm khách hàng
                        </button>
                    </div>
                </form>
            </div>
