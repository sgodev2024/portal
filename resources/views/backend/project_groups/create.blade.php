    ...
    <div class="page-inner">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-gradient-primary text-white d-flex justify-content-between align-items-center">
                <h4 class="mb-0">
                    <i class="fas fa-building me-2"></i> Thêm nhóm dự án mới
                </h4>
            ...
            <div class="card-body p-4">
                ...
                <form action="{{ route('admin.project-groups.store') }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        {{-- Mã dự án (auto-generate) --}}
                        <div class="col-md-6">
                            <label for="code" class="form-label fw-semibold">
                                Mã dự án
                            </label>
                            <input type="text" class="form-control" 
                                value="Tự động tạo (00001001XX)" 
                                disabled readonly>
                            <small class="text-muted">
                                <i class="fas fa-info-circle"></i> Mã sẽ được tạo tự động khi lưu
                            </small>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="total_units" id="total_units" value="{{ old('total_units') }}"
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" id="description" rows="4"
                                ...
                                placeholder="Nhập mô tả về dự án (không bắt buộc)">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <button type="submit" class="btn btn-primary px-4">
                            <i class="fas fa-save me-2"></i> Lưu nhóm dự án
                        </button>
                    </div>
                </form>
            </div>
