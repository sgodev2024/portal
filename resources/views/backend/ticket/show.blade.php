            ...
            <div class="col-12 col-lg-8">
                ...
                <div class="card shadow-lg border-0 mb-4">
                    <div class="card-body p-4 p-lg-5">
                        ...
                        <div class="row g-4">
                            <div class="col-md-4">
                                <small class="text-muted d-block mb-2"><i class="bi bi-envelope me-2"></i>Email khách
                                    hàng</small>
                                <p class="fs-5">
                            ...
                            <div class="col-md-4">
                                <small class="text-muted d-block mb-2"><i class="bi bi-calendar-event me-2"></i>Ngày
                                    tạo</small>
                                <p class="fs-5 fw-semibold">{{ $ticket->created_at->format('d/m/Y H:i') }}</p>
                            </div>
                            <div class="col-md-4">
                                <small class="text-muted d-block mb-2"><i class="bi bi-arrow-repeat me-2"></i>Cập
                                    nhật</small>
                            ...
                            <div class="card-header bg-white border-bottom">
                                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                                    ...
                                    <small class="text-muted"><i
                                            class="bi bi-clock me-1"></i>{{ $message->created_at->format('d/m/Y H:i') }}</small>
                                </div>
                            </div>
                    ...
                    <div class="card shadow-lg border-0 mb-4">
                        ...
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <form action="{{ route('admin.tickets.reply', $ticket->id) }}" method="POST" id="replyForm">
                                @csrf
                                <div class="mb-3">
                                    <label for="admin_reply_message" class="form-label fw-bold fs-5">Phản hồi <span
                                ...
                                <button type="submit" class="btn btn-primary btn-lg"><i class="bi bi-send me-2"></i> Gửi
                                    Phản Hồi</button>
                            </form>
                        </div>
                    </div>
            ...
            <div class="col-12 col-lg-4">
                <div class="card shadow-lg border-0 mb-4 sticky-lg-top" style="top: 20px;">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4 pb-4 border-bottom">
                            <small class="text-muted d-block mb-2"><i class="bi bi-chat-dots me-2"></i>Tổng số tin
                                nhắn</small>
                        ...
                        <div class="card-body p-4">
                            <form action="{{ route('admin.tickets.close', $ticket->id) }}" method="POST"
                                ...
                                <button type="submit" class="btn btn-danger btn-lg w-100"><i
                                        class="bi bi-x-circle me-2"></i> Đóng Ticket</button>
                            </form>
                        </div>
                    </div>
                @else
                ...
                <a href="{{ route('admin.tickets.index') }}" class="btn btn-outline-secondary btn-lg w-100"><i
                        class="bi bi-arrow-left me-2"></i> Quay lại danh sách</a>
            </div>
        </div>
    </div>
