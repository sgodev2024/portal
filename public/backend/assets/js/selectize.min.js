            ...
            a.extend(w.prototype, {
                setup: function () {
                    ...
                    if (
                        ...
                        (e = a("<div>")
                            ...
                            .appendTo(k)),
                        (j = a("<div>")
                            .addClass(r.dropdownContentClass)
                            .appendTo(e)),
                        (o = w.attr("id")) &&
                        ...
                        p.settings.placeholder &&
                            d.attr("placeholder", r.placeholder),
                    ...
                    w.attr("autocorrect") &&
                        d.attr("autocorrect", w.attr("autocorrect")),
                        ...
                        t.on(
                            ["scroll" + s, "resize" + s].join(" "),
                            function () {
                                p.isOpen &&
                                    p.positionDropdown.apply(p, arguments);
                            }
                        ),
                        ...
                        a.isArray(r.items) &&
                            (p.setValue(r.items), delete r.items),
                        i &&
                ...
                search: function (b) {
                    ...
                    if (
                        g.score &&
                        "function" !=
                            typeof (e = f.settings.score.apply(this, [b]))
                    )
                        throw new Error(
                    ...
                    if (
                        ...
                        for (c = d.items.length - 1; c >= 0; c--)
                            -1 !== f.items.indexOf(k(d.items[c].id)) &&
                                d.items.splice(c, 1);
                    return d;
                },
                refreshOptions: function (b) {
                    ...
                    var u = this,
                        ...
                        z =
                            u.$activeOption &&
                            k(u.$activeOption.attr("data-value"));
                    for (
                        g = x.items.length,
                        ...
                        for (
                            ...
                            (m = n[e]),
                                ...
                                h.hasOwnProperty(m) ||
                                    ((h[m] = document.createDocumentFragment()),
                                    i.push(m)),
                                h[m].appendChild(l);
                    for (
                        this.settings.lockOptgroupOrder &&
                            i.sort(function (a, b) {
                                return (
                                    (u.optgroups[a].$order || 0) -
                                    (u.optgroups[b].$order || 0)
                                );
                            }),
                ...
                updateOption: function (b, c) {
                    ...
                    if (
                        ...
                        (j = l.options[b].$order),
                            f !== b &&
                                (delete l.options[b],
                                -1 !== (g = l.items.indexOf(b)) &&
                                    l.items.splice(g, 1, f)),
                            (c.$order = c.$order || j),
                            (l.options[f] = c),
                ...
                addItems: function (b, c) {
                    ...
                    for (
                        var d = this.$control[0].childNodes, e = 0;
                        e < d.length;
                        e++
                    )
                        this.buffer.appendChild(d[e]);
                    for (
                        var f = a.isArray(b) ? b : [b], e = 0, g = f.length;
                        e < g;
                        e++
                    )
                ...
                render: function (b, c) {
                    ...
                    return (
                        ...
                        h.renderCache[b].hasOwnProperty(d))
                            ? h.renderCache[b][d]
                            : ((f = a(
                                  h.settings.render[b].apply(this, [c, l])
                              )),
                              "option" === b || "option_create" === b
                                  ? c[h.settings.disabledField] ||
