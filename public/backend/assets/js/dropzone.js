        ...
        /******/ var __webpack_modules__ = {
            ...
            /***/ 6583: /***/ function (
                ...
                module.exports = FORCED
                    ? function lastIndexOf(
                          ...
                          if (NEGATIVE_ZERO)
                              return (
                                  nativeLastIndexOf.apply(this, arguments) || 0
                              );
                          var O = toIndexedObject(this);
                          var length = toLength(O.length);
                          var index = length - 1;
            ...
            /***/ 4994: /***/ function (
                ...
                var IteratorPrototype =
                    __webpack_require__(3383).IteratorPrototype;
                var create = __webpack_require__(30);
...
*/
            ...
            /***/ 561: /***/ function (
                ...
                var HAS_SPECIES_SUPPORT =
                    arrayMethodHasSpeciesSupport("splice");
        ...
        !(function () {
            ...
            var web_url = __webpack_require__(285); // CONCATENATED MODULE: ./src/emitter.js
   ...
   */
            ...
            var Dropzone = /*#__PURE__*/ (function (_Emitter) {
                ...
                function Dropzone(el, options) {
                    ...
                    var elementOptions =
                        (left = Dropzone.optionsForElement(_this.element)) !=
                        null
                            ? left
                            : {};
                    ...
                    if (_this.options.url == null) {
                        _this.options.url =
                            _this.element.getAttribute("action");
                    }
                    ...
                    if (
                        _this.options.uploadMultiple &&
                        _this.options.chunking
                    ) {
                        throw new Error(
                    ...
                    if (typeof _this.options.method === "string") {
                        _this.options.method =
                            _this.options.method.toUpperCase();
                    }
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function init() {
                                ...
                                if (this.clickableElements.length) {
                                    var setupHiddenFileInput =
                                        function setupHiddenFileInput() {
                                            ...
                                            _this2.hiddenFileInput.className =
                                                "dz-hidden-input";
                                            ...
                                            _this2.hiddenFileInput.style.visibility =
                                                "hidden";
                                            _this2.hiddenFileInput.style.position =
                                                "absolute";
                                            _this2.hiddenFileInput.style.top =
                                                "0";
                                            _this2.hiddenFileInput.style.left =
                                                "0";
                                            _this2.hiddenFileInput.style.height =
                                                "0";
                                            _this2.hiddenFileInput.style.width =
                                                "0";
                                            Dropzone.getElement(
                                                _this2.options
                                ...
                                this.URL =
                                    window.URL !== null
                                        ? window.URL
                                        : window.webkitURL; // Setup all event listeners on the Dropzone object itself.
                                ...
                                this.on("complete", function (file) {
                                    if (
                                        ...
                                        _this2.getUploadingFiles().length ===
                                            0 &&
                        ...
                        },
                        {
                            ...
                            value: function setupEventListeners() {
                                return this.listeners.map(function (
                                    elementListeners
                                ) {
                                    return (function () {
                                        var result = [];
                        ...
                        },
                        {
                            ...
                            value: function filesize(size) {
                                ...
                                if (size > 0) {
                                    ...
                                    selectedSize =
                                        Math.round(10 * selectedSize) / 10; // Cutting of digits
                                }
                        ...
                        },
                        {
                            ...
                            value: function _addFilesFromDirectory(
                                directory,
                                path
                            ) {
                                var _this5 = this;
                                ...
                                var readEntries = function readEntries() {
                                    return dirReader.readEntries(function (
                                        entries
                                    ) {
                                        if (entries.length > 0) {
                                            var _iterator7 =
                                ...
                                return this.createThumbnail(
                                    ...
                                    function (dataUrl, canvas) {
                                        if (canvas == null) {
                                            ...
                                            var resizeMimeType =
                                                _this10.options.resizeMimeType;
                        ...
                        },
                        {
                            ...
                            value: function cancelUpload(file) {
                                if (file.status === Dropzone.UPLOADING) {
                                    var groupedFiles = this._getFilesWithXhr(
                                        file.xhr
                                    );
                                ...
                                this._transformFiles(
                                    ...
                                    function (transformedFiles) {
                                            ...
                                            files[0].upload.chunked =
                                                ...
                                                (_this14.options
                                                    ...
                                                    transformedFile.size >
                                                        _this14.options
                                                            .chunkSize);
                                            files[0].upload.totalChunkCount =
                                                Math.ceil(
                                                    transformedFile.size /
                                                        _this14.options
                                                            .chunkSize
                                        ...
                                        if (files[0].upload.chunked) {
                                            ...
                                            file.upload.finishedChunkUpload =
                                                function (chunk, response) {
                                                    var allFinished = true;
                                                    chunk.status =
                                                        Dropzone.SUCCESS; // Clear the data from the chunk
                        ...
                        },
                        {
                            ...
                            value: function _uploadData(files, dataBlocks) {
                                ...
                                var progressObj =
                                    xhr.upload != null ? xhr.upload : xhr;
                                ...
                                if (this.element.tagName === "FORM") {
                                    ...
                                    try {
                                        for (
                                            ...
                                            if (inputType)
                                                inputType =
                                                    inputType.toLowerCase(); // If the input doesn't have a name, we can't use it.
                        ...
                        },
                        {
                            ...
                            value: function _updateFilesUploadProgress(
                                files,
                                xhr,
                                e
                            ) {
                                if (!files[0].upload.chunked) {
                                    ...
                                    for (
                                        ...
                                        if (
                                            ...
                                            typeof _file2.upload.chunks[i]
                                                .progress !== "undefined"
                                        ) {
                                            _file2.upload.progress +=
                                                _file2.upload.chunks[
                                                    i
                                                ].progress;
                                            _file2.upload.total +=
                                                _file2.upload.chunks[i].total;
                        ...
                        },
                        {
                            ...
                            value: function _handleUploadError(
                                files,
                                xhr,
                                response
                            ) {
                        ...
                        },
                        {
                            ...
                            value: function _errorProcessing(
                                files,
                                message,
                                xhr
                            ) {
